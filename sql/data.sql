...
('GERMAN', 'de', 'Deutsch'),
('GROUPS_URL', 'de', 'https://github.com/edemocracy/beoportal0/'),
...
('HTML_META_TITLE_ARGUMENT', 'de', '[ARGUMENT] - BEO Portal'),
('HTML_META_TITLE_EDIT_ARGUMENT', 'de', 'Argument bearbeiten'),
('HTML_META_TITLE_EDIT_QUESTION', 'de', 'Frage bearbeiten'),
('HTML_META_TITLE_FAQ', 'de', 'Häufige Fragen - BEO Portal'),
('HTML_META_TITLE_IMPRINT', 'de', 'Imprint - BEO Portal'),
('HTML_META_TITLE_MANAGE_GROUP', 'de', 'Gruppe Verwalten'),
('HTML_META_TITLE_MANAGE_PROFILE', 'de', 'Einstellungen - BEO Portal'),
('HTML_META_TITLE_NEWEST', 'de', '[TAGS] Neu - BEO Portal'),
('HTML_META_TITLE_NEW_ARGUMENT', 'de', 'Neues Argument - BEO Portal'),
('HTML_META_TITLE_NEW_COUNTER_ARGUMENT', 'de', 'Neues Gegenargument - BEO Portal'),
('HTML_META_TITLE_NEW_GROUP', 'de', 'Neue Gruppe'),
('HTML_META_TITLE_NEW_QUESTION', 'de', 'Neue Frage - BEO Portal'),
('HTML_META_TITLE_OVERVIEW', 'de', 'Übersicht - BEO Portal'),
('HTML_META_TITLE_PROFILE', 'de', '[USERNAME] - BEO Portal'),
('HTML_META_TITLE_QUESTION', 'de', '[QUESTION] - BEO Portal'),
('HTML_META_TITLE_SIGNUP', 'de', 'Registrieren - BEO Portal'),
('HTML_META_TITLE_TITLE', 'de', '[TAGS] Sortiert - BEO Portal'),
('HTML_META_TITLE_TOP', 'de', '[TAGS] Top - BEO Portal'),
('HTML_META_TITLE_TRENDING', 'de', '[TAGS] Im Trend - BEO Portal'),
('IMPRINT', 'de', 'Impressum'),
('LANGUAGE', 'de', 'Sprache'),
('LIGHTBOX_CLOSE', 'de', 'Schließen'),
('LIGHTBOX_PROMPT_NO', 'de', 'Nein'),
('LIGHTBOX_PROMPT_YES', 'de', 'Ja'),
('LOGIN_ERROR_ACCOUNT_PENDING', 'de', 'Dieser Account ist von dir noch nicht bestätigt worden. Du solltest von BEO Portal eine Bestätigungsmail mit einem Link bekommen haben.'),
...
('SIGNUP_CONFIRMATION_EMAIL_BODY', 'de', 'Hallo [USERNAME],<br /><br />\r\n\r\n<a href = ''[CONFIRMATION_LINK]''>Klicke hier um deinen BEO Portal Account freizuschalten.</a><br /><br />\r\nAlternativ kopiere diesen Link in deinen Browser: [CONFIRMATION_LINK]\r\n<br /><br />'),
('SIGNUP_CONFIRMATION_EMAIL_SUBJECT', 'de', 'BEO Portal Registrierung'),
...
('GERMAN', 'en', 'German'),
('GROUPS_URL', 'en', 'https://github.com/edemocracy/beoportal0/'),
...
('HTML_META_TITLE_IMPRINT', 'en', 'Imprint - BEO Portal'),
('HTML_META_TITLE_MANAGE_GROUP', 'en', 'Administer Group'),
('HTML_META_TITLE_MANAGE_PROFILE', 'en', 'Manage Profile - BEO Portal'),
('HTML_META_TITLE_NEWEST', 'en', '[TAGS] New - BEO Portal'),
('HTML_META_TITLE_NEW_ARGUMENT', 'en', 'New Argument - BEO Portal'),
('HTML_META_TITLE_NEW_COUNTER_ARGUMENT', 'en', 'New Counter-Argument - BEO Portal'),
('HTML_META_TITLE_NEW_GROUP', 'en', 'New Group'),
('HTML_META_TITLE_NEW_QUESTION', 'en', 'New Question - BEO Portal'),
('HTML_META_TITLE_PROFILE', 'en', '[USERNAME] - BEO Portal'),
('HTML_META_TITLE_QUESTION', 'en', '[QUESTION] - BEO Portal'),
('HTML_META_TITLE_SIGNUP', 'en', 'Register - BEO Portal'),
('HTML_META_TITLE_TOP', 'en', '[TAGS] Top - BEO Portal'),
('HTML_META_TITLE_TRENDING', 'en', '[TAGS] Trending - BEO Portal'),
('IMPRINT', 'en', 'Imprint'),
...
('SIGNUP_CONFIRMATION_EMAIL_SUBJECT', 'en', 'BEO Portal Registration'),
